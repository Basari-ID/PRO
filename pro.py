...
author = 'Rochmat&Basari'
github1 = 'github.com/RozhBasXYZ'
github2 = 'github.com/Basari-ID'
facebook1 = 'ROCHMAT BASUKI XD'
facebook2 = 'facebook.com/basari.shp'
...
def crack_publik(t,c):
	...
	try:
		...
		exit(f" [{M}>{P}] pertemanan akun tidak publik")	
...
def crack_masal(t,c):
    ...
    for bz in range(apa):
    	...
    	try:
    		...
    		print(f"\r [{kk}!{P}] pertemanan akun tidak publik       ")
    		continue	                       		
    atur_atur()
...
def atur_atur():
	...
	if apk in ['y','Ya','ya','YA']:akunok.append('apk')
